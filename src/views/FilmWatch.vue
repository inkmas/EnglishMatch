      ...
      <el-card shadow="hover" class="video-card">
        ...
        <div class="video-wrapper">
          <video
              ...
              preload="auto"
              class="main-video"
              poster="/assets/videos/沙家浜/page.png"
...
const videoSrc = "/assets/videos/沙家浜/《沙家浜》（长影1971）DVDRip.x264.mp4"

// 恢复进度的核心逻辑
const restoreProgress = () => {
  if (player.value) {
    const savedTime = videoStore.getProgress(videoSrc)
    if (savedTime > 0) {
...
const handleTimeUpdate = () => {
  if (player.value && player.value.currentTime > 0) {
    ...
    videoStore.updateProgress(videoSrc, player.value.currentTime)
  }
}
